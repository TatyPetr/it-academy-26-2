...
//поэтому результат может быть неожиданным. 
// Например, строка может привести к конкатенации, undefined — к NaN, null — к 0, а true — к 1. 
// Для JavaScript это ожидаемо, но для калькулятора такое поведение не всегда удобно. 
// Поэтому нужно добавить валидацию входных данных и разрешать работу только с числами.
